...
def getCourses(self,clist): #updates added clist parameter
        #courses = []       #updates removed list instantiation within method
        course = {}
    ...
    def clearAndSearch(self, num, pre):
        ...
        def scrapeWriteAndModifySearch(self,courseslist): #updates added course list parameter
        self.getCourses(self,courseslist)                 #updates added course list parameter *snag: self. is already a paramter, adding courseslist parameter results in getCourses() takes exaclty 2 arguments (3 given)
        sleep(1)
        self.writeJson()
        self.modifySearch()
        sleep(1)
    ...
    def scrape(self):
        ...
        courses = [] #updates added list instantiation pre loop execution this way the same list is appended to without creating new lists within the list.
        ...
        while(i < len(courseNumList)):
            ...
            self.scrapeWriteAndModifySearch(courses)  #updates added courses parameter 
            i = i + 1
